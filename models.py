    ...
    def __init__(self, model_name, batch_size, gpu_memory):
        ...
        if model_name in ['pt_vgg', 'pt_resnet', 'pt_inception', 'pt_densenet']:
            ...
            if model_name in ['pt_post_avg_cifar10', 'pt_post_avg_imagenet']:
                ...
                model = model.cuda()
                print('IN last else statemetn in ModelPT class... model_path_dict[model_name] = ',model_path_dict[model_name] )
...
model_path_dict = {'madry_mnist_robust': 'madry_mnist/models/robust',
                   ...
                   'pt_medical_mnist_resnet50': 'medicalMNISTmodels/resnet50_medicalMNIST_final',
                   'pt_medical_mnist_inception': 'medicalMNISTmodels/inception_medicalMNIST_final',
		   'pt_medical_mnist_vgg16': 'medicalMNISTmodels/vgg16_medicalMNIST_final'
                   }
model_class_dict = {'pt_vgg': torch_models.vgg16_bn,
                    ...
                    'pt_medical_mnist_resnet50': torch_models.resnet50,
		    'pt_medical_mnist_inception': torch_models.inception_v3,
		    'pt_medical_mnist_vgg16': torch_models.vgg16
                    }
