...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='pt_medical_mnist_resnet50', choices=models.all_model_names, help='Model name.')
    ...
    parser.add_argument('--dataset', type=str, default='medical_mnist', choices=['medical_mnist', 'mnist', 'cifar10', 'imagenet'], help='Dataset name.')
...
#AG
    print('os enrion gpu:', os.environ["CUDA_VISIBLE_DEVICES"])
    print('TOrch cuda:', torch.cuda.is_available())
    ...
    gpu_memory = 0.5 if dataset == 'medical_mnist' and args.n_ex > 1000 else 0.15 if dataset == 'medical_mnist' else 0.99
